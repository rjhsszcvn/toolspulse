...
const categoryColors: Record<ToolCategory, string> = {
  ...
  image: "bg-green-50 text-green-600 border-green-100",
  text: "bg-yellow-50 text-yellow-600 border-yellow-100",
  developer: "bg-purple-50 text-purple-600 border-purple-100",
  generator: "bg-blue-50 text-blue-600 border-blue-100",
  ai: "bg-pink-50 text-pink-600 border-pink-100",
};

const categoryIconColors: Record<ToolCategory, string> = {
        ...
        <div className="mx-auto max-w-7xl px-4 py-20 sm:px-6 sm:py-28 lg:px-8">
          <div className="text-center">
            <div className="mb-6 inline-flex items-center rounded-full border border-blue-200 bg-blue-50 px-4 py-1.5 text-sm font-medium text-blue-700">
              ...
              100% Free &middot; No Signup &middot; No Upload to Servers
            </div>
            ...
            <p className="mx-auto mt-6 max-w-2xl text-lg text-gray-600">
              20+ free online tools for PDF, images, text, and more. Everything
          ...
          {/* Trust badges */}
          <div className="mt-16 flex flex-wrap items-center justify-center gap-x-10 gap-y-4 text-sm text-gray-500">
      ...
      <section id="tools" className="mx-auto max-w-7xl px-4 py-16 sm:px-6 lg:px-8">
        <div className="text-center mb-12">
          ...
          <p className="mt-3 text-gray-600">
            Choose from {tools.length}+ free tools — more added every week
          </p>
        </div>
          ...
          return (
            <div key={key} id={key} className="mb-16">
              <div className="mb-6 flex items-center gap-3">
                <div className={`rounded-lg p-2 ${categoryIconColors[key as ToolCategory]}`}>
              ...
              <div className="grid gap-4 sm:grid-cols-2 lg:grid-cols-3">
                {categoryTools.map((tool) => (
                  <Link key={tool.id} href={`/tools/${tool.slug}`} className="tool-card group">
                    <div className="flex items-start gap-4">
                      <div className={`rounded-lg p-2.5 ${categoryIconColors[tool.category]}`}>
                      ...
                      <svg className="h-5 w-5 text-gray-300 group-hover:text-blue-500 transition-colors flex-shrink-0 mt-1" fill="none" viewBox="0 0 24 24" strokeWidth={2} stroke="currentColor">
        ...
        <div className="mx-auto max-w-3xl px-4 py-16 sm:px-6 lg:px-8">
          ...
          <div className="space-y-6">
            {[
              ...
              {
                q: "Are my files safe?",
                a: "Absolutely. All processing happens directly in your browser. Your files are never uploaded to our servers. We literally cannot see your data.",
              },
              {
                q: "Is there a file size limit?",
                a: "Since everything runs in your browser, the limit depends on your device's memory. Most files under 100MB process instantly. Larger files may take a bit longer.",
              },
              {
                q: "Do I need to create an account?",
                a: "No. Every tool works immediately — no signup, no email, no account required. Just open the tool and start using it.",
              },
              {
                q: "Can I use these tools on mobile?",
                a: "Yes. All tools are fully responsive and work on smartphones, tablets, and desktop computers across all modern browsers.",
              },
            ].map((faq, i) => (
