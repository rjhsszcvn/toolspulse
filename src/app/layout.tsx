    ...
    <html lang="en">
      <head>
        ...
        <meta name="google-site-verification" content="6vkJFnHwHifL5TpqvVaG4vZo0dnsW1eJ65qSe0TF8zc" />
          ...
          <script dangerouslySetInnerHTML={{ __html: `(function(s){s.dataset.zone='10937888',s.src='https://n6wxm.com/vignette.min.js'})([document.documentElement, document.body].filter(Boolean).pop().appendChild(document.createElement('script')))` }} />
